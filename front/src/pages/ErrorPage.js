...
const ErrorPage = () => {
  return (
    <div className="ErrorPage">
      ...
      <div className='errmessage' style={{marginLeft: '47%', fontSize: '20pt', fontWeight: 'bold'}}>
          Sorry...
      </div><br/>
      <div className='errmessage2' style={{fontSize: '11pt', textAlign: 'center', fontWeight: 'bold'}}>
          추천 결과가 없습니다.<br/>
          혹시 이렇게 하지는 않으셨나요?
      </div><br/>
